...
$SQL = EjecutarSP('sp_tbl_PagosClientes_Correos', $Param);
if (!$SQL) {
    $sw_error = 1;
...
$SQL_Encabezado = Seleccionar("tbl_PagosClientes_Correos", "id", "hora_creacion = $fecha_hora");
...
foreach ($lineas as &$linea) {
    ...
    $SQL_Detalle = EjecutarSP('sp_tbl_PagosClientes_Correos_Detalle', $Param_Detalle);
    if (!$SQL_Detalle) {
        $sw_error = 1;
