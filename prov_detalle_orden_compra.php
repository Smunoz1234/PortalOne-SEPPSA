    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
         ...
         <div class="wrapper wrapper-content">
		  ...
		  <br>
		  <?php if(PermitirFuncion(602)){?>
		  <div class="row">
			 <div class="col-lg-12">
				<div class="ibox-content">	
					<a href="sapdownload.php?id=<?php echo base64_encode('15');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($rowDoc['ID_OrdenCompra']);?>&ObType=<?php echo base64_encode('22');?>&IdFrm=<?php echo base64_encode($rowDoc['IdSeries']);?>" target="_blank" class="btn btn-outline btn-success"><i class="fa fa-download"></i> Descargar formato</a>
				</div>
			</div>
		</div>
		<br>
