...
if ($id != "") {
    ...
    $SQL_Encabezado = Seleccionar("tbl_PagosClientes_Correos", "*", "id=$id");
    ...
    // Cuerpo o detalle.
    $Cons = "SELECT * FROM tbl_PagosClientes_Correos_Detalle WHERE id=$id";
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
				...
				<div class="col-sm-4">
					<div class="title-action">
						<a href="consultar_envio_correo_clientes.php" class="alkin btn btn-outline btn-default"><i class="fa fa-arrow-circle-o-left"></i> Regresar a consultar</a>
					</div>
				</div>
            </div>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<div class="ibox-content">
					  ...
					  <form action="envio_correo_clientes.php" method="get" id="formBuscar" class="form-horizontal">
				...
				success: function(response) {
					if(response == "OK") {
						Swal.fire({
							...
							window.location.href = "consultar_envio_correo_clientes.php";
						});
					} else {
						Swal.fire({
